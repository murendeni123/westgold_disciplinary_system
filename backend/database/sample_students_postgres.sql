-- PostgreSQL version of sample students data
...
INSERT INTO classes (id, class_name, grade_level, teacher_id, academic_year) VALUES
...
-- Reset sequence for classes if needed
...
ON CONFLICT (student_id, class_id, attendance_date, period) DO NOTHING;

...
# Refactor parent pages
echo "Starting parent pages color refactoring..."
...
# Refactor ModernParentLayout
LAYOUT_FILE="src/layouts/ModernParentLayout.tsx"
...
echo "Parent pages refactoring complete!"

...
echo "Starting platform pages color refactoring..."
...
# Refactor PlatformLayout
LAYOUT_FILE="src/layouts/PlatformLayout.tsx"
...
echo "Platform pages refactoring complete!"

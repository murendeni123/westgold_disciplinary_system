...
echo "Fixing all hardcoded light colors in admin pages..."

# Find all admin page files
ADMIN_FILES=$(find src/pages/admin src/layouts -type f -name "*.tsx")
...
for file in $ADMIN_FILES; do
  ...
  # Replace light colored backgrounds used for sections
...
echo "Fixed all hardcoded light colors in admin pages!"

...
const NotificationsPage: React.FC = () => {
  ...
  const getNotificationIcon = (type: string) => {
    switch (type) {
      ...
      case 'student':
        return <GraduationCap className="text-purple-500" size={24} />;
      default:
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <motion.button
          ...
          className="px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
        >
          <CheckCheck size={20} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div className="lg:col-span-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 text-sm bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                />
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              ...
              <select
                ...
                className="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all appearance-none cursor-pointer"
              >
            ...
            <div className="lg:col-span-1">
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
              />
            </div>
            ...
            <AnimatePresence>
              {filteredNotifications.map((notification, index) => (
                <motion.div
                  ...
                  className={`p-6 hover:bg-gradient-to-r hover:from-emerald-50 hover:to-teal-50 cursor-pointer transition-all ${

    ...
    <div className="space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-gray-600 mt-2">Platform-wide notifications and alerts</p>
        </div>
        <motion.button
          ...
          className="px-6 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white rounded-xl font-medium shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
        >
          <CheckCheck size={20} />
            ...
            <AnimatePresence>
              {filteredNotifications.map((notification, index) => (
                <motion.div
                  ...
                  className={`p-6 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 cursor-pointer transition-all ${
